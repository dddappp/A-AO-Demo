...
print("🔧 Registering ExecuteNftEscrowTransaction handler...")
local execute_handler_result = Handlers.add(
    "NftEscrowService_ExecuteNftEscrowTransaction",
    function(msg)
        print("🔍 ExecuteNftEscrowTransaction matcher called - Action: " .. tostring(msg.Action))
        local matches = msg.Action == "NftEscrowService_ExecuteNftEscrowTransaction"
        print("🔍 Matches: " .. tostring(matches))
        return matches
    end,
    function(msg, env, response)
        print("🎯 HANDLER TRIGGERED: NftEscrowService_ExecuteNftEscrowTransaction")
        print("📋 Message From: " .. tostring(msg.From) .. ", Target: " .. tostring(msg.Target or ao.id))
...
print("✅ ExecuteNftEscrowTransaction handler registered: " .. tostring(execute_handler_result))
...
Handlers.add(
    ...
    function(msg, env, response)
        print("🎯 HANDLER TRIGGERED: NftEscrowService_UseEscrowPayment")
        print("📋 Message From: " .. tostring(msg.From) .. ", Target: " .. tostring(msg.Target or ao.id))
        ...
        if not success then
            print("❌ use_escrow_payment failed: " .. error_msg)
        else
            print("✅ use_escrow_payment completed successfully")
        end
    end
)
...
Handlers.add(
    "basic_test",
    function(msg)
        print("🔍 BASIC CHECK: Received message with Action='" .. tostring(msg.Action) .. "'")
        return msg.Action == "TestMessage"
    end,
    function(msg, env)
        print("🎉 BASIC HANDLER: Test message received!")
...
function init_nft_escrow_service()
    print("🔧 Initializing NFT Escrow Service...")
    ...
    print("✅ NFT Escrow Service initialized")
...
Handlers.add(
    ...
    function(msg, env)
        print("🔄 SELF-PING: Internal message received in process " .. ao.id)
    end
)
...
Handlers.add(
    ...
    function(msg, env)
        print("🏓 PING RECEIVED: Process " .. ao.id .. " is alive")
        Send({
            Target = msg.From,
            Action = "Pong",
