...
class FileBundle {
    ...
    toTransaction(attributes, arweave, jwk) {
        return __awaiter(this, void 0, void 0, function* () {
            const streams = [(0, fs_1.createReadStream)(this.headerFile), ...this.txs.map((t) => (0, fs_1.createReadStream)(t))];
            const stream = multistream_1.default.obj(streams);
            const tx = yield (0, promises_1.pipeline)(stream, (0, arweave_stream_tx_1.createTransactionAsync)(attributes, arweave, jwk));
    ...
    signAndSubmit(arweave, jwk, tags = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, promises_1.pipeline)(stream2, (0, arweave_stream_tx_1.uploadTransactionAsync)(tx, arweave));
            return tx;
        });
    }
    getHeaders() {
