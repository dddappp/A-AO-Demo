...
-- 插入测试用户
INSERT INTO users (username, email, password_hash, display_name, auth_provider, enabled, email_verified)
VALUES ('testuser', 'test@example.com',
        '$2a$10$slYQmyNdGzin7olVN3p5Be7DlH.PKZbv5H8KnzzVgXXbVxzy8QKOT',
        'Test User', 'LOCAL', true, true);
